...
namespace derek_csharp_15
{
    class Program
    {
        ...
        {
            string[] dogs = { "K 9", "Brian Griffin", "Scooby Doo", "Old Yeller", "Rin Tin Tin", "Benji", "Charlie B. Barkin", "Lessie", "Snoopy" };
        ...
        static void QueryCollection()
        {
            var animalList = new List<Animal>()
            {
                ...
                new Animal{Name = "German Shepherd", Height = 30, Weight = 200 }
            };
        ...
        static void QeueryAnimalData()
        {
            Animal[] animals = new[]
            {
                ...
                new Animal { Name = "Pug", Height=15, Weight=16, AnimalID = 1 },
